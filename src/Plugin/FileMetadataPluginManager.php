...
class FileMetadataPluginManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/file_mdm', $namespaces, $module_handler, 'Drupal\file_mdm\Plugin\FileMetadataInterface', 'Drupal\file_mdm\Plugin\Annotation\FileMetadata');
